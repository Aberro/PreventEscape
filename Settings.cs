...
namespace PreventEscape
{
	public class Settings : AttributeSettings<Settings>
	{
		...
		[SettingPropertyGroup("Escape")]
		[SettingProperty("Max. days in captivity", 0, 420, false, "For how long a prisoner could be kept by AI players, if no one ransomed a hero and he can't escape")]
		public int CaptivityDaysLimit { get; [UsedImplicitly] set; } = CampaignTime.DaysInYear;
		...
		[SettingProperty("Relations improvement", 0, 100, false, "Increase in relations of prisoner to it's ransomer")]
		public int RansomRelationImprovement { get; [UsedImplicitly] set; } = 10;
		[SettingPropertyGroup("Relations")]
		[SettingProperty("Relations improvement", 0, 100, false, "Decrease in relations of prisoner to it's captor when captor decline offer")]
		public int RansomRejectRelationDeterioration { get; [UsedImplicitly] set; } = 2;
		[SettingPropertyGroup("Relations")]
		[SettingProperty("Relations improvement", 0, 100, false, "Increase in relations of prisoner to it's captor when captor decline barter offer")]
